 ...
 */
 ...
 // ************************************************************************************ 
 //this is the servise Component for the talked to API, or any other web servises  
 // ************************************************************************************ 
...
export class CustomerServiceService {
  ...
  getCustomersList() {  
    ...
    //----------------------------
    /*
    this.http.get('https://www.limber.io/stage/customers.json').subscribe((res: any[]) => {
      this.CustomerList = res;
      return this.CustomerList;
    });
    */
   this.CustomerList = this.CustomerJson;
